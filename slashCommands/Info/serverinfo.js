  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    try {
      ...
      if (boosts >= 30) maxbitrate = 384000;
        ...
        .addField(client.la[ls].cmds.info.serverinfo.field12, "<a:nitro_logo:935819251443449886> \`" + message.guild.premiumSubscriptionCount + "\`", true)
        .addField(client.la[ls].cmds.info.serverinfo.field13, "<a:nitro_logo:935819251443449886> \`" + boostlevel + "\`", true)
