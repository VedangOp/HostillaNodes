...
module.exports = {
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    try {
      ...
      .addField("<a:YellowArrow:933595864209956864> PNG",`[\`LINK\`](${guild.iconURL({format: "png"})})`, true)
      .addField("<a:YellowArrow:933595864209956864> JPEG",`[\`LINK\`](${guild.iconURL({format: "jpg"})})`, true)
      .addField("<a:YellowArrow:933595864209956864> WEBP",`[\`LINK\`](${guild.iconURL({format: "webp"})})`, true)
