      ...
      async function first_layer(){
        ...
        async function menuselection(menu) {
          ...
          if(menu?.values[0] == "Information"){
            ...
            await message.reply({ content: "<a:YES:932995837003460649> **The Current Anti-Nuke Settings**", embeds: [new MessageEmbed()
              .setColor(es.color)
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leaves:934690623775207445> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Bot add__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leaves:934690623775207445> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Kick/Ban__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leaves:934690623775207445> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Create Role__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leaves:934690623775207445> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Delete Role__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leaves:934690623775207445> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Channel Create__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leaves:934690623775207445> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Channel Delete__ Whitelist (module)!**`.substring(0, 2048))
              ...
              menuoptions = [
                {
                  ...
                  emoji: client.Anti_Nuke_System.get(message.guild.id, "all.enabled") ? "933261310588760115": "932995837003460649"
                },
                {
                  value: "Set Logger",
                ...
                },
                {
                  ...
                  emoji: client.Anti_Nuke_System.get(message.guild.id, "all.showwhitelistlog") ? "933261310588760115": "932995837003460649"
                },
                {
                    ...
                    async function first_layer(){
                      menuoptions = [
                        {
                          ...
                          emoji: client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`) ? "933261310588760115": "932995837003460649"
                        },
                        {
                      ...
                      client.on('interactionCreate',  (menu) => {
                        if (menu?.message.id === menumsg.id) {
                          if (menu?.user.id === cmduser.id) {
                            if(used33) return menu?.reply({content: `<:M_x:933261310588760115> You already selected something, this Selection is now disabled!`, ephemeral: true})
                    ...
                    async function handle_the_picks_X(menuoptionindex, menuoptiondata) {
                      ...
                      await tempmsg.channel.awaitMessages({filter: m => m.author.id === cmduser.id,
                        ...
                        .then(collected => {
                          ...
                          if(isNaN(thenumber)){
                            return message.reply(`<:M_x:933261310588760115> **Your Input is not a real Number**\n> \`${String(thenumber).substring(0, 50)}\``)
                          }
            ...
            return menu?.reply({content: "<a:YES:932995837003460649> **Now using the Suggested Settings!**", embeds: [new MessageEmbed()
              .setColor(es.color)
              .setFooter(client.getFooter(es))
