    ...
    try {
      ...
      async function handle_the_picks(optionhandletype, SetupNumber, menuoptiondata) {
        switch (optionhandletype) {
          ...
          case "New Channel":
          {
            if(client.social_log.get(message.guild.id, "twitch.channels").length > 10) return message.reply("<:M_x:933261310588760115> **You can't have more then 10 Twitch Channels**");
