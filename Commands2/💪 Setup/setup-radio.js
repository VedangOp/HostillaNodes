...
module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix) => {
      ...
      try{
        ...
        //send the message of the searching <a:music:932981891185901631> <a:music:932981891185901631> 
        message.reply(
            new Discord.MessageEmbed()
                .setTitle("<a:music:932981891185901631> Setup Complete for Radio Station:  " + song.title)
                .setColor("#7fafe3")
