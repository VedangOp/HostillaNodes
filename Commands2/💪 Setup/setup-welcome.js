                    ...
                    switch (optionhandletype) {
                      ...
                      case `Frame Color`:{
                        ...
                        let row1 = new MessageActionRow().addComponents([
                          new MessageButton().setStyle("SECONDARY").setCustomId("#FFD700").setEmoji("⬜").setLabel("#FFD700"),
                        ...
                        //Once the Collections ended edit the menu message
                        collector.on('end', collected => {
                          tempmsg.edit({embeds: [tempmsg.embeds[0].setDescription(`~~${tempmsg.embeds[0].description}~~`)], components: [], content: `${collected && collected.first() && collected.first().customId ? `<a:YES:932995837003460649> **Selected the \`${collected.first().customId}\` Color**` : "❌ **NOTHING SELECTED - CANCELLED**" }`})
                        });
                        //Menu Collections
                        collector.on('collect', async button => {
                          if (button?.user.id === cmduser.id) {
                            ...
                            button?.reply("<:M_x:933261310588760115> **Only the Command Executor is allowed to react!**")
                          }
                        })
                      } break;
                    }
            ...
            async function dm_msg_autoimg(member) {
              ...
              //member roles add on welcome every single role
                ...
                if (client.settings.get(member.guild.id, "welcome.framedm")) {
                  ...
                  if (framecolor == "WHITE") framecolor = "#FFD700";
                ...
                if (fillcolors == "WHITE") framecolor = "#FFD700";
            ...
            async function msg_autoimg(member) {
              ...
              try {
                ...
                const welcomeembed = new Discord.MessageEmbed()
                  ...
                  if (fillcolor == "WHITE") framecolor = "#FFD700";
