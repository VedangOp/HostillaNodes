          ...
          await tempmsg.channel.awaitMessages({
            ...
            .then(async collected => {
              try {
                ...
                message.reply({
                  embeds: [new Discord.MessageEmbed()
                    .setTitle(`<a:YES:932995837003460649> Set the TWITTER USER ID TO: \`${collected.first().content}\``.substring(0, 256))
                ...
                await tempmsg.channel.awaitMessages({
                  ...
                  .then(async collected => {
                    try {
                      ...
                      return message.reply({
                        embeds: [new Discord.MessageEmbed()
                          .setTitle(`<a:YES:932995837003460649> Set the TWITTER USER Name TO: \`${collected.first().content}\``.substring(0, 256))
...
/**
 * @INFO
 * Bot Coded by BEAST AMPLIFIER#1334 | https://github?.com/MilratoDev/discord-js-lavalink-Music-Bot-erela-js
 * @INFO
