                ...
                case "Add a VC": {
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author.id,
                    ...
                    .then(collected => {
                      ...
                      if(!Voicechannel || !Textchannel || Voicechannel.type != "GUILD_VOICE" || Textchannel.type != "GUILD_TEXT") return message.reply("<:M_x:933261310588760115> **Check the example in the Embed, wrong input type!**")
                      try {
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<a:YES:932995837003460649> I will now send Messages after someone joins the VC \`${Voicechannel.name}\` in the TextChannel **${Textchannel.name}**`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
                ...
                case "Remove a VC": {
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author.id,
                    ...
                    .then(collected => {
                      ...
                      if(!Voicechannel || Voicechannel.type != "GUILD_VOICE") return message.reply("<:M_x:933261310588760115> **Check the example in the Embed, wrong input type!**")
                      try {
                        let a = client.joinvc.get(message.guild.id, "vcmessages")
                        //remove invalid ids
                        for(const vc of a){
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<a:YES:932995837003460649> Successfully removed **${Voicechannel.name}** out of the Setup!`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
                ...
                case "Add a VC": {
                  ...
                  await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author.id,
                    ...
                    .then(collected => {
                      ...
                      if(!Voicechannel || !Role) return message.reply("<:M_x:933261310588760115> **Check the example in the Embed, wrong input type!**")
                      ...
                      try {
                        ...
                        return message.reply({embeds: [new Discord.MessageEmbed()
                          .setTitle(`<a:YES:932995837003460649> I will now Add the Role \`${Role.name}\` when someone joins the VC **${Discord.VoiceChannel.name}**`)
                          .setColor(es.color)
                          .setFooter(client.getFooter(es))
                        ]});
                      } catch (e) {
