...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      let approve = new MessageButton().setStyle('SUCCESS').setCustomId('1').setEmoji("932995837003460649").setLabel("YES DO IT!")
      let deny = new MessageButton().setStyle('PRIMARY').setCustomId('2').setEmoji("933261310588760115").setLabel("Cancel")
