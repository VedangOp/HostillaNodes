  ...
  module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix) => {
      ...
      try {
        ...
        if(!snipes) return message.reply("<:M_x:933261310588760115> There is no Deleted Message");
        const snipe = args[0] && !isNaN(args[0]) ? Number(args[0]) - 1 : 0;
        const targetSnipe = snipes[snipe];
        if(!targetSnipe) return message.reply("<:M_x:933261310588760115> There is no Deleted Message")
