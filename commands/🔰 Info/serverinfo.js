...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player) => {
    ...
    try {
      ...
      embed.addField("**<a:YellowArrow:933595864209956864> Rules Channel:**", `${message.guild.rulesChannel ? `<#${message.guild.rulesChannelId}>`: "<:M_x:933261310588760115> \`No Channel\`"}`, true)
      embed.addField("**<a:YellowArrow:933595864209956864> Public Updates Channel:**", `${message.guild.publicUpdatesChannel ? `<#${message.guild.publicUpdatesChannelId}>`: "<:M_x:933261310588760115> \`No Channel\`"}`, true)
      embed.addField("**<a:YellowArrow:933595864209956864> AFK Channel:**", `${message.guild.afkChannel ? `<#${message.guild.afkChannelId}>`: "<:M_x:933261310588760115> \`No Channel\`"}`, true)

      embed.addField("**<a:YellowArrow:933595864209956864> NSFW Level:**", `\`${message.guild.nsfwLevel}\``, true)
      embed.addField("**<a:YellowArrow:933595864209956864> Verifcation Level:**", `\`${message.guild.verificationLevel}\``, true)
      embed.addField("**<a:YellowArrow:933595864209956864> Explicit Content Filter:**", `\`${message.guild.explicitContentFilter}\``, true)
      ...
      embed.addField(client.la[ls].cmds.info.serverinfo.field12, "<a:nitro_logo:935819251443449886> \`" + message.guild.premiumSubscriptionCount + "\`", true)

      embed.addField(client.la[ls].cmds.info.serverinfo.field13, `<a:nitro_logo:935819251443449886> \`${boostlevel}\``, true)
      embed.addField(client.la[ls].cmds.info.serverinfo.field14, "👾 \`" + maxbitrate + " kbps\`", true)
      if(boosts >= 14){
          embed.addField(`**<a:YellowArrow:933595864209956864> Vanity:**`, `${message.guild.vanityURLCode ? `https://discord.gg/${message.guild.vanityURLCode}` : "<:M_x:933261310588760115> No Vanity-Invite"}`)
      }
      ...
      if(message.guild.banner) {
        ...
        .setTitle(`**<a:YellowArrow:933595864209956864> SERVER BANNER:**`)
        ...
        let embed2 = new Discord.MessageEmbed()
        .setTitle(`**<a:YellowArrow:933595864209956864> SERVER DISCOVERY SPLASH:**`)
