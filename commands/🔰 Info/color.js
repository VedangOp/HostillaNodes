  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    let ls = client.settings.get(message.guild.id, "language")
      ...
      const embed = new Discord.MessageEmbed()
        ...
        .addField('<a:YellowArrow:933595864209956864> **Name**', "```"+json.name+"```", true)
        .addField("<a:YellowArrow:933595864209956864> **Hex**",  "```"+json.hex+"```", true)
        .addField("<a:YellowArrow:933595864209956864> **RGB**",  "```"+json.rgb+"```", true)
        .addField(`<a:YellowArrow:933595864209956864> **${client.la[ls].cmds.info.color.brightershade}**`,  "```"+json.brightened +"```", true)
