...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      .addField("<a:YellowArrow:933595864209956864> PNG",`[\`LINK\`](${message.guild.iconURL({format: "png"})})`, true)
      .addField("<a:YellowArrow:933595864209956864> JPEG",`[\`LINK\`](${message.guild.iconURL({format: "jpg"})})`, true)
      .addField("<a:YellowArrow:933595864209956864> WEBP",`[\`LINK\`](${message.guild.iconURL({format: "webp"})})`, true)
