                ...
                this.message.reply({
                        ...
                        gameCollector.on('collect', async btn => {
                                if (btn.customId == a11 && gameData[player].member.id === btn.user.id) {
                                        ...
                                        return btn.reply({
                                                content: '<:M_x:933261310588760115> **Wait for opponent.**',
                                                ephemeral: true
                                        })
                                }
...
module.exports = {
        ...
        run: async (client, message, args, cmduser, text, prefix) => {
                ...
                if (!opponent) return message.reply(`<:M_x:933261310588760115> **Please mention who you want to challenge at tictactoe.**`);
                new TicTacToe({
                        ...
                        oEmoji: '935025938859700294', //Optional EMOJI / CustomEMOJI-ID
                }).start();
                return;
        }
}