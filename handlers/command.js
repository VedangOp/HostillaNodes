...
console.log("Welcome to SERVICE HANDLER /--/ By https://milrato.eu /--/ Discord: BEAST AMPLIFIER#1334".yellow);
      ...
      member.send({
        embeds: [
          new MessageEmbed()
            .setColor(ee.color)
            .setThumbnail(member.guild.iconURL({dynamic: true}))
            .setAuthor(`Giveaway Entry Confirmed`, `https://cdn.discordapp.com/emojis/932995837003460649.gif?size=128`)
      ...
      member.send({
        embeds: [
          new MessageEmbed()
            .setColor(ee.wrongcolor)
            .setThumbnail(member.guild.iconURL({dynamic: true}))
            .setAuthor(`Giveaway Left!`, `https://cdn.discordapp.com/emojis/932995837003460649.gif?size=128`)
      ...
      winner.send({
        ...
        embeds: [
          new MessageEmbed()
            ...
            .setAuthor(`Giveaway Won!`, `https://cdn.discordapp.com/emojis/932995837003460649.gif?size=128`)
