      ...
      try {
        ...
        if(channel && channel.permissionsFor(channel.guild.me).has(Permissions.FLAGS.SEND_MESSAGES)){
          ...
          collector.on('collect', async i => {
              ...
              if (!player)
                return i?.reply({content: "<:M_x:933261310588760115> Nothing Playing yet", ephemeral: true})
...
/**
* @INFO
* Bot Coded by BEAST AMPLIFIER#1334 | https://github?.com/Tomato6966/discord-js-lavalink-Music-Bot-erela-js
* @INFO
...
var embed = new MessageEmbed().setColor(ee.color)
  embed.setAuthor(`${track.title}`, "https://images-ext-1.discordapp.net/external/DkPCBVBHBDJC8xHHCF2G7-rJXnTwj_qs78udThL8Cy0/%3Fv%3D1/https/cdn.discordapp.com/emojis/932981891185901631.gif", track.uri)
