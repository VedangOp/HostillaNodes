...
module.exports = (client, preindex) => {
  ...
  client.on("interactionCreate", async (interaction) => {
    ...
    if (!index) {
      return interaction?.editReply("<:M_x:933261310588760115> Could not find the Database for your Ticket!");
    }
    ...
    guild.channels.create(channelname.substring(0, 31), optionsData).then(async ch => {
      ...
      interaction?.editReply({ content: "<:M_x:933261310588760115> **Something went wrong!**", ephemeral: true })
      console.error(e)
    })
  });
}
